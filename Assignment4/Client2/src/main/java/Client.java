...
public class Client {
  ...
  public static List<RequestData> requestRecords = new CopyOnWriteArrayList<>();
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      Statistics.calculateAndPrintStats(requestRecords);
      DataProcessor.writeDataToCSV(requestRecords);
